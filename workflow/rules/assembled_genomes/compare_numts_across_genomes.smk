...
rule merge_all_comparisons:
    input:
        ...
        comparisons=expand("data/genome_comparison/regions_extracted_from_maf/Sscrofa11.1/{other_species}/{other_assembly_name}/both_sides_compared/GCF_000003025.6_vs_{other_assembly_accession}.csv",
                        zip,

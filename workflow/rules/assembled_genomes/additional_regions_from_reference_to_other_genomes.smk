rule get_new_reference_numt_coords:
    ...
    run:
        ...
        coords = all[all["REF11_region_id"].str.contains(":")][
            "REF11_region_id"
        ].tolist()
...
rule update_all_numts:
    input:
        ...
        dfs=expand(
            "data/genome_comparison/additional_regions_found_in_reference/regions_extracted_from_maf/Sscrofa11.1/{other_species}/{other_assembly_name}/{other_assembly_accession}_in_GCF_000003025.6.csv",
            zip,

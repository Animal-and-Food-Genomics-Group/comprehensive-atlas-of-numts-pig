...
df_bt.columns=['other_chromosome','main_chromosome','%_identity', 'aln_length','mismatches','gap_opens','other_start','other_end','main_start','main_end']
...
rev_df_bt.columns=['other_chromosome','main_chromosome','%_identity', 'aln_length','mismatches','gap_opens','other_start','other_end','main_start','main_end']
...
rev_df.columns=[i.replace("other_",f'{main}_').replace("main_",f'other_') for i in rev_df.columns]
